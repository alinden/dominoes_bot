...
case class AvgNode(
  ...
  def heuristic(): Score = {
    ...
    val isLockedGame =
      afterGame.playerOne.hand.isEmpty && afterGame.playerTwo.hand.isEmpty
    val isDominoes =
      !isLockedGame && (afterGame.playerOne.hand.isEmpty || afterGame.playerTwo.hand.isEmpty)
    val isRobotTurn =
      afterGame.activePlayer() == afterGame.playerByName("robot")
